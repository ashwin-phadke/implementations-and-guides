...
upperThreshold : Upper threshold for the image edge detection
lowerThreshold : Lower threshold for the image edge detection
size : size of kernel used in sobel(accuracy)
*/
    ...
    // Step 2: Calculating gradient magnitudes and directions(Calculating sobel)
    ...
    //Calculate slope at each point , derivative of y by x.
